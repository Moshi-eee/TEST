...
const apibusinessunit = new Resource("user/maintenance/lodging");
...
const headers = [
  ...
  { title: "Room", align: "left", key: "room" },
  { title: "Building", align: "left", key: "building" },
  { title: "Floor", align: "left", key: "floor" },
...
<template>
  ...
  <v-row>
    <v-dialog v-model="dialog" persistent width="500">
      <v-card>
        <v-card-title>
          <span class="text-h5 pa-2">Lodging</span>
        </v-card-title>
        <v-card-text>
          <v-container>
            <v-row>
