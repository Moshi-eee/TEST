...
const apibusinessunit = new Resource("user/maintenance/department");
...
<template>
  <h2 class="mb-3">Department</h2>
  <v-row justify="start">
    <v-col cols="4">
      <v-btn
        @click="dialog = !dialog"
        :disabled="
          !authStore.check('view-employee-maintenance-department-can-add')
        "
        >Add New</v-btn
      >
    </v-col>
  ...
  <v-row>
    <v-dialog v-model="dialog" persistent width="500">
      <v-card>
        <v-card-title>
          <span class="text-h5 pa-2">Department</span>
        </v-card-title>
        <v-card-text>
          <v-container>
            <v-row>
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            v-if="actions == 'edit'"
            :disabled="
              !authStore.check('view-employee-maintenance-department-can-edit')
            "
            @click="update"
          >
            update
