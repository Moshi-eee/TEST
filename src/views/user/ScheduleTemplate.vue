...
const apibusinessunit = new Resource("user/template_schedule");
...
const headers = [
  ...
  { title: "time_in", align: "left", key: "time_in" },
  { title: "time_out", align: "left", key: "time_out" },
...
<template>
  <h2 class="mb-3">Schedule Template</h2>
  <v-row justify="start">
    <v-col cols="4">
  ...
  <v-row>
    <v-dialog v-model="dialog" persistent width="600">
      <v-card>
        <v-card-title>
          <span class="text-h5 pa-2">Add Schedule Template</span>
        </v-card-title>
        <v-card-text>
          <v-container>
            <v-row>
