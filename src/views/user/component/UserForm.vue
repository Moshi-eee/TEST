...
const rules = ref({
  ...
  emp_code: [
    (v) => !!v || "Required Field",
    (v) => (v && v.length < 13) || "Characters must be less than 13 characters",
    (v) =>
      (v && v.length >= 8) || "Characters must be greater than 8 characters",
  ],
...
const save = async () => {
  ...
  await apiUser
    ...
    .then((e) => {
      ...
      setTimeout(() => router.push("/user/list"), 500);
    })
    .catch((e) => {
  ...
  <v-form ref="myForm" validate-on="submit lazy" @submit.prevent="savedata">
    ...
    <v-row>
      ...
      <v-col cols="12" md="3">
        <v-text-field
          label="Biometric *"
          v-model="form.biometric"
          :rules="rules.biometric"
          required
          density="compact"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="4">
        <v-select
          ...
          required
          density="compact"
          :items="['Executive', 'Manager', 'Supervisor', 'Rank and File']"
          variant="underlined"
          :loading="loading"
          :disabled="loading"
        >
      ...
      <v-col cols="12" md="3">
        <v-autocomplete
          ...
          required
          density="compact"
          :items="default_data ? default_data.position : []"
          item-title="code"
          item-value="id"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="3">
        <v-autocomplete
          ...
          required
          density="compact"
          :items="default_data ? default_data.department : []"
          item-title="code"
          item-value="id"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="2">
        <v-autocomplete
          ...
          required
          density="compact"
          :items="default_data ? default_data.business_units : []"
          item-title="code"
          item-value="id"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="2">
        <v-autocomplete
          hide-selected
          label="Sub Business Units "
          v-model="form.sub_business_unit_id"
          required
          density="compact"
          :items="default_data ? default_data.sub_business_units : []"
          item-title="code"
          item-value="id"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="2">
        <v-autocomplete
          hide-selected
          label="Billing Units "
          v-model="form.billing_unit_id"
          required
          density="compact"
          :items="default_data ? default_data.billing_unit_id : []"
          item-title="code"
          item-value="id"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="3">
        <v-text-field
          label="Date Probationary *"
          v-model="form.date_provisionary"
          :rules="rules.date_provisionary"
          type="date"
          required
          density="compact"
          variant="underlined"
      ...
      <v-col cols="12" md="3">
        <v-text-field
          ...
          v-model="form.date_regularization"
          type="date"
          required
          density="compact"
          variant="underlined"
      ...
      <v-col cols="12" md="3">
        <v-text-field
          label="Date Resignation"
          v-model="form.date_resignation"
          type="date"
          required
          density="compact"
          variant="underlined"
      ...
      <v-col
        cols="12"
        md="12"
        v-if="form.date_resignation && form.type == 'Separated'"
      >
        <v-text-field
          label="Reason of resignation"
          v-model="form.reason_resignation"
          required
          density="compact"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="3">
        <v-combobox
          ...
          v-model="form.immediate_supervisor1"
          required
          density="compact"
          :items="default_data ? default_data.user_list : []"
          item-title="emp_code"
          item-value="user_id"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="3">
        <v-combobox
          label="Immediate Supervisor "
          v-model="form.immediate_supervisor2"
          required
          density="compact"
          :items="default_data ? default_data.user_list : []"
          item-title="emp_code"
      ...
      <v-col cols="12" md="3">
        <v-combobox
          label="Immediate Supervisor "
          v-model="form.immediate_supervisor3"
          required
          density="compact"
          :items="default_data ? default_data.user_list : []"
          item-title="emp_code"
      ...
      <v-col cols="12" md="2">
        <v-autocomplete
          hide-selected
          label="Lodging"
          v-model="form.lodging_id"
          required
          density="compact"
          :items="default_data ? default_data.lodging : []"
          item-title="code"
          item-value="id"
          variant="underlined"
          :loading="loading"
      ...
      <v-col cols="12" md="4">
        <v-text-field
          label="ATM Date Recieved"
          v-model="form.account_date_recv"
          type="date"
          required
          density="compact"
          variant="underlined"
